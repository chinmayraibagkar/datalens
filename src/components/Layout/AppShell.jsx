            ...
            <aside className={`sidebar ${sidebarOpen ? '' : 'collapsed'}`}>
                <div className="sidebar-header">
                    <div className="sidebar-brand">
                        ...
                        <h1>DataLens AI</h1>
                        <span style={{ fontSize: '0.6rem', fontWeight: 500, background: 'var(--accent-gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginLeft: '4px', letterSpacing: '0.04em' }}>v0.3</span>
                    </div>
